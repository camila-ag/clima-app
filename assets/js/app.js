...
/**
 * Añade event listener a multiples elementos
...
/**
 * Renderizar toda la data del clima a la pagina html
...
export const updateWeather = function (lat, lon) {
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        fetchData(url.airPollution(lat, lon), function(airPollution){
            ...
            card.innerHTML = `
              <h2 class="title-2" id="highlights-label">Destacado de Hoy</h2>
              ...
              <div class="highlight-list">
                  ...
                  <div class="card card-sm highlight-card two">
                      <h3 class="title-3">Salida y Puesta de Sol</h3>
                      <div class="card-list">
                          <div class="card-item">
                              <span class="m-icon">clear_day</span>
                              <div>
                                  <p class="label-1">Salida de Sol</p>
                          ...
                          <div class="card-item">
                              ...
                              <div>
                                  <p class="label-1">Puesta de Sol</p>
                  ...
                  <div class="card card-sm highlight-card">
                      <h3 class="title-3">Presión del aire</h3>
                      <div class="wrapper">
                  ...
                  <div class="card card-sm highlight-card">
                      <h3 class="title-3">Temperatura aparente</h3>
                      <div class="wrapper">
          ...
          for (const [index, data] of forecastList.entries()){
            ...
            tempLi.innerHTML = `
              <div class="card card-sm slider-card">
                ...
                <img src="./assets/images/weather_icons/${icon}.png" width="48" height="48" alt="${description}" class="weather-icon" title="${description}">
